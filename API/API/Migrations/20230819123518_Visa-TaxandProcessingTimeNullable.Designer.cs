...
namespace Glomad.Migrations
{
    ...
    [Migration("20230819123518_Visa-TaxandProcessingTimeNullable")]
    partial class VisaTaxandProcessingTimeNullable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Models.Visa", b =>
                {
                    ...
                    b.Property<byte?>("ProcessingTimeTo")
                        .HasColumnType("tinyint");

                    b.Property<byte?>("ProcessingTimeUp")
                        .HasColumnType("tinyint");
            ...
            modelBuilder.Entity("Glomad.Models.Country", b =>
                {
                    ...
                    b.Property<string>("NextCountries")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("PopularCountries")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Glomad.Models.PopularCountries", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("API.Models.CountryQuestion", b =>
                {
                    b.HasOne("Glomad.Models.Country", "Citizen")
                        .WithMany()
            ...
            modelBuilder.Entity("Glomad.Models.PopularCountries", b =>
                {
                    b.HasOne("Glomad.Models.Country", "Citizenship")
                        .WithMany()
